...
class Asset:
    ...
    The class includes basic details of the asset like name, unitName, number of decimals supported and ratio from base units to unit.
    ...
    def build_opt_in_tx(
        ...
        Args:
            ...
            suggested_params: The general parameters for the transaction based on the particular client.
    ...
    def get_holding(self, address: str) -> Optional[int]:
        ...
        Returns:
            The amount of this asset the account is holding, or None if it can't hold this asset.
        """
