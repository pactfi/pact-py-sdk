"""PactClient is a simple client to handle requests to the pact exchange.
    ...
    The module wraps the AlgodClient to allow you to query the pact exchange.
...
class PactClient:
    ...
    def fetch_asset(self, asset_index: int) -> Asset:
        ...
        Args:
            asset_index: The id number for the ASA asset.
    ...
    def fetch_pools_by_assets(
        ...
        Args:
            primary_asset: Primary asset for the pool to find.
            secondary_asset: Secondary asset for the pool to find.
