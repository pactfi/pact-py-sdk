...
def get_app_ids_from_assets(
    ...
    Args:
        pact_api_url: The url for the pact AMM. This is used to which between the main and test sights.
        primary_asset_index: The algorand asset id for the primary asset of the pool.
        secondary_asset_index: The algorand asset id for the secondary asset of the pool.
...
class Pool:
    ...
    The class is primarily called from the :py:meth:`pactsdk.client.PactClient.fetch_pool_by_id` or :py:meth:`pactsdk.client.PactClient.fetch_pools_by_assets` instead.
    ...
    * Create a Swap on the Pool.
    ...
    def update_state(self) -> PoolState:
        """Updates the internal and pool state properties by re-reading the global state in the block chain.
    ...
    def prepare_add_liquidity_tx_group(
        ...
        Args:
            address: Account address that will deposit the primary and secondary assets and receive the lp asset.
    ...
    def build_add_liquidity_txs(
        ...
        Args:
            ...
            note: An optional note that can be added to the application ADDLIQ transaction when executed.
    ...
    def prepare_remove_liquidity_tx_group(
        ...
        Args:
            address: Account address that will deposit the lp asset and receive the primary and secondary assets.
            amount: The amount of the lp asset to return to the pool.

        Returns:
            TransactionGroup: Transaction group that when executed will remove liquidity from the pool.
        """
        suggested_params = self.algod.suggested_params()
    ...
    def build_remove_liquidity_txs(
        ...
        - "REMLIQ" application call to remove the lp asset from the account and receive the deposited assets in return.
    ...
    def prepare_swap(
        ...
        Args:
            ...
            slippage_pct: The maximum allowed slippage in percents e.g. `10` is 10%. The swap will fail if slippage will be higher.
